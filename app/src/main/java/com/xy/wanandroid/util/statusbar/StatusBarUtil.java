package com.xy.wanandroid.util.statusbar;
...
public class StatusBarUtil {
     ...
     * 网易云界面设置红色状态栏
     */
    public static void setNeteaseFullScreen(Activity activity) {
        Window window = activity.getWindow();
        window.setStatusBarColor(Color.parseColor("#df4b48"));
    }
    ...
    public static void setImmeriseStatusBar(Activity activity) {
        Window window = activity.getWindow();
